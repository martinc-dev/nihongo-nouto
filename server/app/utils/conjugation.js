...
const conjugationForms = [
  ...
  {
    name: 'past tense',
    forms: ['った', 'いた', 'いだ', 'した', 'った', 'んだ', 'んだ', 'んだ', 'った', 'た', 'した', 'きた']
  },
  {
    name: 'polite affirmative',
    forms: [
  ...
  // Renyoukei: 12-13
  { name: 'conjunctive', forms: ['い-', 'き-', 'ぎ-', 'し-', 'ち-', 'み-', 'び-', 'に-', 'り-', '-', 'し-', 'き-'] },
  {
    name: 'way of doing',
    forms: ['いかた', 'きかた', 'ぎかた', 'しかた', 'ちかた', 'みかた', 'びかた', 'にかた', 'りかた', 'かた', '?', '?']
  },

  // Te forms: 14-22
  {
    name: 'te form',
    forms: ['って', 'いて', 'いで', 'して', 'って', 'んで', 'んで', 'んで', 'って', 'て', 'して', 'きて']
  },
  {
    name: 'te iru',
    forms: [
  ...
  },
  {
    ...
    forms: ['っとる', 'いとる', 'いどる', 'しとる', 'っとる', 'んどる', 'んどる', 'んどる', 'っとる', 'とる', '?', '?']
  },
  {
    name: 'te oku',
    forms: [
  ...
  },
  {
    ...
    forms: ['っとく', 'いとく', 'いどく', 'しとく', 'っとく', 'んどく', 'んどく', 'んどく', 'っとく', 'とく', '?', '?']
  },
  ...
  {
    name: 'pseudo futurum',
    forms: ['おう', 'こう', 'ごう', 'そう', 'とう', 'もう', 'ぼう', 'のう', 'ろう', 'よう', 'しよう', 'こよう']
  },
  {
  ...
  {
    name: 'hypothetical',
    forms: ['えば', 'けば', 'げば', 'せば', 'てば', 'めば', 'べば', 'ねば', 'れば', 'れば', 'すれば', 'くれば']
  },
  {
  ...
  },
  {
    ...
    forms: ['える', 'ける', 'げる', 'せる', 'てる', 'める', 'べる', 'ねる', 'れる', '', 'できる', 'こられる']
  },
  ...
  { name: 'commanding', forms: ['え', 'け', 'げ', 'せ', 'て', 'め', 'べ', 'ね', 'れ', 'ろ', 'しろ', 'こい'] },
  {
    name: 'authoritative',
    forms: [
      'いなさい',
  ...
  },
  {
    ...
    forms: ['うな', 'くな', 'ぐな', 'すな', 'つな', 'むな', 'ぶな', 'ぬな', 'るな', 'るな', 'するな', 'くるな']
  },

  // Belief about [...]ness: 42-44
  {
    name: 'looks to be the case',
    forms: ['いそう', 'きそう', 'ぎそう', 'しそう', 'ちそう', 'みそう', 'びそう', 'にそう', 'りそう', 'そう', '?', '?']
  },
  {
...
const verbTypes = ['V5U', 'V5K', 'V5G', 'V5S', 'V5T', 'V5M', 'V5B', 'V5N', 'V5R', 'V1', 'IRS', 'IRK']
const verbEndings = ['う', 'く', 'ぐ', 'す', 'つ', 'む', 'ぶ', 'ぬ', 'る', 'る', 'る', 'る']
